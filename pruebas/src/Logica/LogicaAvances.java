...
public class LogicaAvances {
    ...
    public boolean guardarReporteGeneral(int idProy, double porcentaje, String desc, int idItem, Double nuevaCant) {
        Connection con = null;
        try {
            // Obtenemos la conexión desde tu clase de base de datos
            ...
            try (PreparedStatement pstAvance = con.prepareStatement(sqlAvance)) {
            ...
            try (PreparedStatement pstEstado = con.prepareStatement(sqlUpdateEstado)) {
            ...
            try (PreparedStatement pst2 = con.prepareStatement(sqlPresupuesto)) {
            ...
            // Siempre cerramos la conexión para liberar memoria en Clever Cloud
            if (con != null) {
                try {
                    con.close();
                } catch (SQLException e) {
